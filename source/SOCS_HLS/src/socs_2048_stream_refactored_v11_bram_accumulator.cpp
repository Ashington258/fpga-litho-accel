...
// ============================================================================
// Stage 3: Accumulate intensity to BRAM (Stable for RTL simulation)
// ============================================================================
...
void accumulate_to_bram(
    ...
    for (int y = 0; y < MAX_FFT_Y; y++) {
        for (int x = 0; x < MAX_FFT_X; x++) {
            ...
            // Direct BRAM accumulation (no DDR read-modify-write)
...
// ============================================================================
// Stage 3b: Write BRAM to DDR (One-time write)
// ============================================================================
...
// ============================================================================
// Main function with BRAM accumulator (v11)
// ============================================================================

void calc_socs_2048_hls_stream_refactored_v11(
    float* mskf_r, float* mskf_i,
    float* krn_r, float* krn_i,
    float* scales,
    ...
    // BRAM accumulator (stable for RTL simulation)
    float tmpImg_local[MAX_FFT_Y][MAX_FFT_X];
