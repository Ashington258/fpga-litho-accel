/**
 * @file tb_socs_1024_stream_refactored_v6.cpp
 * @brief Testbench for SOCS 2048 Stream Refactored v6 (Phase 3 - DDR Optimized)
 * 
 * Validates the DDR optimization (tmpImg_final in DDR) against golden_1024 data.
 */
