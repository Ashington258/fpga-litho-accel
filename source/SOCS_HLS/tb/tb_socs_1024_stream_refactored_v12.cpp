/**
 * @file tb_socs_1024_stream_refactored_v12.cpp
 * @brief Testbench for SOCS 2048 Stream Refactored v12 (Direct DFT Only)
 * 
...
extern void calc_socs_2048_hls_stream_refactored_v12(
...
int main() {
    ...
    printf("Step 3: Running calc_socs_2048_hls_stream_refactored_v12 (Direct DFT Only)...\n");
    ...
    calc_socs_2048_hls_stream_refactored_v12(
        mskf_r, mskf_i,
        krn_r, krn_i,
        scales,
