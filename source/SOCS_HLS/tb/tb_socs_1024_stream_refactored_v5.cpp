/**
 * @file tb_socs_1024_stream_refactored_v5.cpp
 * @brief Testbench for SOCS 2048 Stream Refactored v5 (Phase 3 - BRAM Optimized)
 * 
 * Validates the BRAM optimization (remove tmpImg_local) against golden_1024 data.
 */
