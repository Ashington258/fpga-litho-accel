/**
 * @file tb_socs_1024_stream_refactored_v11.cpp
 * @brief Testbench for SOCS 2048 Stream Refactored v11 (Phase 3 - BRAM Accumulator)
 * 
...
extern void calc_socs_2048_hls_stream_refactored_v11(
...
int main() {
    ...
    calc_socs_2048_hls_stream_refactored_v11(
        mskf_r, mskf_i,
        krn_r, krn_i,
        scales,
