/**
 * @file tb_socs_1024_stream_refactored_v3.cpp
 * @brief Testbench for SOCS 2048 Stream Refactored v3 (Phase 3 - Multi-FFT Parallelization)
 * 
 * Validates the multi-FFT instance parallelization against golden_1024 data.
 */
...
int main() {
    ...
    printf("Step 3: Running calc_socs_2048_hls_stream_refactored (v4)...\n");
    printf("[INFO] Stream depth optimized: 16384 → 4096\n");
    ...
    if (rmse < tolerance) {
        ...
        printf("  - Interval: Should be < Latency (pipeline overlap achieved)\n");
        printf("  - BRAM: May increase due to parallel instances\n");
        printf("====================================================\n");
        return 0;
    } else {
