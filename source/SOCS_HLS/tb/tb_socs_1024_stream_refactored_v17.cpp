...
extern void calc_socs_2048_hls_stream_refactored_v17(
...
int main() {
    ...
    printf("Step 3: Running calc_socs_2048_hls_stream_refactored_v17 (HLS FFT IP with Unscaled Mode)...\n");
    ...
    // Call HLS function
    calc_socs_2048_hls_stream_refactored_v17(
        mskf_r, mskf_i,
        krn_r, krn_i,
        scales,
        tmpImg_ddr,
