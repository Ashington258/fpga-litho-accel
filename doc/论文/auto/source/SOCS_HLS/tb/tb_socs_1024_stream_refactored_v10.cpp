/**
 * @file tb_socs_1024_stream_refactored_v10.cpp
 * @brief Testbench for SOCS 2048 Stream Refactored v10 (Phase 3 - BRAM Accumulator)
 * 
 * Validates the BRAM accumulator optimization (fix for Co-Sim NaN) against golden_1024 data.
 */
...
extern void calc_socs_2048_hls_stream_refactored_v10(
...
int main() {
    ...
    printf("Step 3: Running calc_socs_2048_hls_stream_refactored (v8 - Reduced Parallelism)...\n");
    printf("[INFO] Single FFT instance (saves ~304 BRAM)\n");
    printf("[INFO] DDR-based FFTshift (no BRAM arrays)\n");
    ...
    calc_socs_2048_hls_stream_refactored_v10(
        mskf_r, mskf_i,
        krn_r, krn_i,
        scales,
