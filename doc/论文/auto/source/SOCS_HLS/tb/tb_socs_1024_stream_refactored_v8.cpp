/**
 * @file tb_socs_1024_stream_refactored_v8.cpp
 * @brief Testbench for SOCS 2048 Stream Refactored v8 (Phase 3 - Reduced Parallelism)
 * 
 * Validates the reduced parallelism optimization (UNROLL factor=1) against golden_1024 data.
 */
