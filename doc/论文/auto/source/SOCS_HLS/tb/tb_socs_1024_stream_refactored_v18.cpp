/**
 * @file tb_socs_1024_stream_refactored_v18.cpp
 * @brief Testbench for SOCS 2048 Stream Refactored v18 (Fixed Latency)
 * 
 * PURPOSE: Validate v18 with fixed loop bounds for Co-Simulation
 * 
 * KEY CHANGE: v18 uses MAX_KERNEL_SIZE (17) as compile-time constant loop bounds
 * This allows HLS to determine exact latency → Co-Simulation works
 */
...
extern void calc_socs_2048_hls_stream_refactored_v18(
...
int main() {
    printf("====================================================\n");
    printf("SOCS 1024 Stream Refactored v18 Validation\n");
    printf("HLS FFT IP with Fixed Latency (Compile-time Loop Bounds)\n");
    printf("====================================================\n");
    ...
    printf("  Mode: Block Floating Point with fixed loop bounds\n");
    printf("====================================================\n\n");
    ...
    printf("Step 3: Running calc_socs_2048_hls_stream_refactored_v18 (Fixed Latency)...\n");
    printf("[INFO] Using MAX_KERNEL_SIZE=17 as compile-time constant loop bounds\n");
    printf("[INFO] Expected: RMSE < 1e-5 (matching v17)\n");
    ...
    // Call HLS function
    calc_socs_2048_hls_stream_refactored_v18(
        mskf_r, mskf_i,
        krn_r, krn_i,
        scales,
        tmpImg_ddr,
    ...
    if (rmse < 1e-5) {
        ...
        printf("v18 Fixed Latency mode passed validation\n");
        return 0;
    } else {
        printf("FAIL: RMSE >= 1e-5\n");
        printf("Precision issue detected\n");
        return 1;
    }
}
