/**
 * Minimal FFT Test for Co-Simulation Debug (No AXI)
 * Purpose: Test HLS FFT IP in isolation without AXI interfaces
 */
...
// Top-level function for HLS (no AXI, pure logic)
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "HLS FFT IP Minimal Test (No AXI)" << std::endl;
    std::cout << "========================================" << std::endl;
